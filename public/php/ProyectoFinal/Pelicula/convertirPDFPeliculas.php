                ...
                if (!$resultado2) {
                    ...
                    if($fila2['Foto']!=null){
                        ...
                        if($adm==0){
                            ...
                            if($formato2=="webp"){
                               ...
                               $pdf->Image("http://localhost/proyectoFinal/Pelicula/verFotoPelicula.php?n=".$valor["idPelicula"]."&p=".$id,30,115.5,50,75,$formato2);
                            }    
                    ...
                    if($fila['foto']!=null){
                        ...
                        if($formato=="webp"){
                           ...
                           $pdf->Image("http://localhost/proyectoFinal/Pelicula/verFotoPeliculaBD.php?n=".$valor["idPelicula"],115,115.5,50,75,$formato);
