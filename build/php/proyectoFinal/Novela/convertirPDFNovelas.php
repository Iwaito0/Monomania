                ...
                if (!$resultado2) {
                    ...
                    if($fila2['Foto']!=null){
                        ...
                        if($formato2=="webp"){
                            ...
                            $pdf->Image("https://monomania-ivg.000webhostapp.com/php/proyectoFinal/Novela/verFotoNovela.php?n=".$valor["idNovelas"]."&p=".$id,30,132,50,75,$formato2);
                        }
                        }
                        else {
                            $tipo_foto2=$fila2['formato'];
                    ...
                    if($fila['foto']!=null){
                        ...
                        if($formato=="webp"){
                            $pdf->Image("../nSuported.png",115,130,50,75,"png");
                             ...
                             $pdf->Image("https://monomania-ivg.000webhostapp.com/php/proyectoFinal/Novela/verFotoNovelaBD.php?n=".$valor["idNovelas"] ,115,130,50,75,$formato);
                        }
                      }
                    else{
                        $tipo_foto2=$fila2['formato'];
